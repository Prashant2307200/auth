...
func (x *PublicKeyResponse) GetPem() string {
	if x != nil {
		return x.Pem
	}
	return ""
...
const file_proto_auth_proto_rawDesc = "" +
	...
	"\x03pem\x18\x01 \x01(\tR\x03pem2C\n" +
	"\vAuthService\x124\n" +
	"\fGetPublicKey\x12\v.auth.Empty\x1a\x17.auth.PublicKeyResponseB9Z7auth/internal/infrastructure/transport/rpc/proto;authpbb\x06proto3"
...
var file_proto_auth_proto_goTypes = []any{
	...
	(*PublicKeyResponse)(nil), // 1: auth.PublicKeyResponse
}
var file_proto_auth_proto_depIdxs = []int32{
	0, // 0: auth.AuthService.GetPublicKey:input_type -> auth.Empty
	1, // 1: auth.AuthService.GetPublicKey:output_type -> auth.PublicKeyResponse
